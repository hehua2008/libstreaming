...
public class UriParser {
    public static final String TAG = UriParser.class.getSimpleName();
    ...
    public static Session parse(String uri) throws IllegalStateException, IOException {
        ...
        if (params.size() > 0) {
            ...
            // Those parameters must be parsed first or else they won't necessarily be taken into
            // account
            for (String paramName : paramKeys) {
                ...
                // CAMERA -> the client can choose between the front facing camera and the back
                // facing camera
                ...
                // UNICAST -> the client can use this to specify where he wants the stream to be
                // sent
                ...
                // VIDEOAPI -> can be used to specify what api will be used to encode video (the
                // MediaRecorder API or the MediaCodec API)
                ...
                // AUDIOAPI -> can be used to specify what api will be used to encode audio (the
                // MediaRecorder API or the MediaCodec API)
