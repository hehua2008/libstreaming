...
public class MP4Parser {
    ...
    private final Map<String, Long> mBoxes = new HashMap<>();
    ...
    private void parse(String path, long len) throws IOException {
        ...
        while (sum < len) {
            ...
            if (validBoxName(buffer)) {
                ...
                // 1061109559+8 correspond to "????" in ASCII the HTC Desire S seems to write
                // that sometimes, maybe other phones do
                // "wide" atom would produce a newlen == 0, and we shouldn't throw an exception
                // because of that
...
class StsdBox {
    ...
    /**
     * Parse the stsd box in an mp4 file
     * fis: proper mp4 file
