...
public class SurfaceView extends android.view.SurfaceView implements Runnable,
     ...
     */
    public static class ViewAspectRatioMeasurer {
         ...
         *
         * @param widthMeasureSpec  The width <tt>MeasureSpec</tt> passed in your
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec, double aspectRatio) {
            ...
            int widthSize =
                    widthMode == MeasureSpec.UNSPECIFIED ? Integer.MAX_VALUE : MeasureSpec.getSize(
                            widthMeasureSpec);
            int heightMode = MeasureSpec.getMode(heightMeasureSpec);
            int heightSize =
                    heightMode == MeasureSpec.UNSPECIFIED ? Integer.MAX_VALUE : MeasureSpec.getSize(
                            heightMeasureSpec);
