...
public abstract class MediaStream implements Stream {
    protected static final String TAG = MediaStream.class.getSimpleName();
    ...
    protected static final byte SUGGESTED_MODE;
     ...
     */
    protected static final byte PIPE_API;

    /**
     * The packetizer that will read the output of the camera and send RTP packets over the
     * networked.
     */
    ...
    static {
        ...
        byte mode = MODE_MEDIARECORDER_API;
        try {
            Class.forName("android.media.MediaCodec");
            // Will be set to MODE_MEDIACODEC_API at some point...
            mode = MODE_MEDIACODEC_API;
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT_WATCH) {
            PIPE_API = PIPE_API_PFD;
        } else {
            PIPE_API = PIPE_API_LS;
        }
    }

    public MediaStream() {
        mRequestedMode = SUGGESTED_MODE;
        mMode = SUGGESTED_MODE;
    }
     ...
     * <br />
     *
     * @param mode Can be {@link #MODE_MEDIARECORDER_API}, {@link #MODE_MEDIACODEC_API}
     *             or {@link #MODE_MEDIACODEC_API_2}
     */
