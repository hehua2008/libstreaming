...
public abstract class VideoStream extends MediaStream {
     ...
     * You can call this method at any time and changes will take effect next time you start the
     * stream.
     *
     * @param camera Can be either CameraInfo.CAMERA_FACING_BACK or CameraInfo.CAMERA_FACING_FRONT
     */
     ...
     * You can call this method at any time and changes will take effect next time you call {@link
     * #start()}.
     */
        ...
        if (mCamera != null) {
            ...
            if (parameters.getFlashMode() == null) {
                ...
                parameters.setFlashMode(
                        state ? Parameters.FLASH_MODE_TORCH : Parameters.FLASH_MODE_OFF);
                try {
    ...
    public synchronized void start() throws IllegalStateException, IOException {
        ...
        super.start();
        Log.d(TAG, "Stream configuration: FPS: " + mQuality.framerate + " Width: " + mQuality.resX
    ...
    protected synchronized void createCamera() throws RuntimeException {
        ...
        if (mCamera == null) {
            ...
            try {
                ...
                Parameters parameters = mCamera.getParameters();
                if (parameters.getFlashMode() != null) {
                    parameters.setFlashMode(mFlashEnabled ? Parameters.FLASH_MODE_TORCH
    ...
    private void measureFramerate() {
        ...
        try {
            ...
            if (mSettings != null) {
                ...
                editor.putInt(
                        PREF_PREFIX + "fps" + mRequestedQuality.framerate + "," + mCameraImageFormat
