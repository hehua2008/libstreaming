 ...
 * and {@link #setVideoQuality(VideoQuality)} to configure the stream.
 * You can then call {@link #start()} to start the RTP stream.
 * Call {@link #stop()} to stop the stream.
 */
public class H264Stream extends VideoStream {
    public static final String TAG = H264Stream.class.getSimpleName();
    ...
    public H264Stream(int cameraId) {
        super(cameraId);
        mMimeType = MediaFormat.MIMETYPE_VIDEO_AVC;
    ...
    private MP4Config testMediaCodecAPI() throws RuntimeException, IOException {
        ...
        try {
            ...
            EncoderDebugger debugger = EncoderDebugger.debug(mSettings, mQuality.resX,
                    mQuality.resY);
