...
public class CodecManager {
    ...
    /**
     * Contains a list of encoders and color formats that we may use with a
     * {@link CodecManager.Translator}.
     */
    static class Codecs {
    ...
    static class Selector {
        private static final Map<String, SparseArray<ArrayList<String>>> sHardwareCodecs =
                new HashMap<>();
        private static final Map<String, SparseArray<ArrayList<String>>> sSoftwareCodecs =
                new HashMap<>();
        ...
        public static Codecs findCodecsFormMimeType(String mimeType,
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2
                ...
                if (list.hardwareCodec != null) {
                    Log.v(TAG, "Choosen primary codec: " + list.hardwareCodec
            ...
            if (list.softwareCodec != null) {
                Log.v(TAG, "Choosen secondary codec: " + list.hardwareCodec
                        + " with color format: " + list.softwareColorFormat);
            } else {
                Log.e(TAG, "No supported software codec found !");
            }
        ...
        static private void findSupportedColorFormats(String mimeType) {
            ...
            for (int i = 0; i < softwareCodecs.size(); i++) {
                e.append(softwareCodecs.keyAt(i)).append(", ");
            }
            for (int i = 0; i < hardwareCodecs.size(); i++) {
                e.append(hardwareCodecs.keyAt(i));
                e.append(i == hardwareCodecs.size() - 1 ? "." : ", ");
            }
